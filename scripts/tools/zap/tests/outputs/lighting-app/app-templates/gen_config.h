...
#define MATTER_DM_DELTADELFIN_ANIMATION_GRADIENT_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_DELTADELFIN_ANIMATION_GRADIENT_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
