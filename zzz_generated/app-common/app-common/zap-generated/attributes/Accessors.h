...
Protocols::InteractionModel::Status
Get(EndpointId endpoint, chip::app::Clusters::DeltadelfinAnimationGradient::DisplayModeEnum * value); // DisplayModeEnum
Protocols::InteractionModel::Status Set(EndpointId endpoint,
                                        chip::app::Clusters::DeltadelfinAnimationGradient::DisplayModeEnum value);
Protocols::InteractionModel::Status
Set(EndpointId endpoint, chip::app::Clusters::DeltadelfinAnimationGradient::DisplayModeEnum value, MarkAttributeDirty markDirty);
} // namespace DisplayMode
