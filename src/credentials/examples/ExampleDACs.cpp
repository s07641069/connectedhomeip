...
// #error 111111
// ------------------------------------------------------------ 
// Pai CERTIFICATE credentials/test/attestation/test-PAI-1141-cert.der 

constexpr uint8_t Pai_Cert_Array[] = {
    0x30, 0x82, 0x01, 0xa9, 0x30, 0x82, 0x01, 0x4e, 0xa0, 0x03, 0x02, 0x01, 0x02, 0x02, 0x08, 0x6e,
    0x27, 0x2e, 0x5a, 0x16, 0x08, 0x6b, 0x0d, 0x30, 0x0a, 0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d,
    ...
    ,
    ...
    ,
};

ByteSpan kPaiCert = ByteSpan(Pai_Cert_Array);

// Pai PUBLIC KEY FROM credentials/test/attestation/test-PAI-1141-key.pem 

constexpr uint8_t Pai_PublicKey_Array[] = {
    0x04, 0x49, 0x7f, 0x54, 0x1b, 0xde, 0x64, 0xf9, 0xe1, 0x3e, 0x83, 0xe6, 0xe0, 0xb0, 0x6c, 
    0x61, 0x77, 0xca, 0x4f, 0x4d, 0x7a, 0xe7, 0x67, 0xdf, 0xd3, 0xc5, 0xc6, 0x4c, 0x37, 0x2c, 
    0x59, 0x6a, 0xc5, 0x15, 0x50, 0x0c, 0xe9, 0x8a, 0x9e, 0x0a, 0x3d, 0x30, 0x71, 0x52, 0x97, 
    0xac, 0x7e, 0x9e, 0x25, 0x02, 0xb7, 0xeb, 0x55, 0x27, 0x0b, 0x12, 0x95, 0x94, 0xc7, 0x29, 
    0x78, 0x40, 0xbe, 0xd0, 0x49
};

ByteSpan kPaiPublicKey = ByteSpan(Pai_PublicKey_Array);

// Pai PRIVATE KEY FROM credentials/test/attestation/test-PAI-1141-key.pem 

constexpr uint8_t Pai_PrivateKey_Array[] = {
    0xe1, 0x23, 0x5a, 0xb6, 0x24, 0x07, 0x2d, 0x9c, 0x56, 0x5a, 0x22, 0x58, 0x70, 0x73, 0xdb, 
    0x98, 0xac, 0x3f, 0xa6, 0x3e, 0x17, 0x1a, 0xe2, 0x12, 0xa4, 0xc2, 0x13, 0xdd, 0x3b, 0x0f, 
    0x12, 0xde
};
...
// ------------------------------------------------------------ 
// Dac CERTIFICATE credentials/test/attestation/test-DAC-1141-8005-cert.der 

constexpr uint8_t Dac_Cert_Array[] = {
    0x30, 0x82, 0x01, 0xd0, 0x30, 0x82, 0x01, 0x76, 0xa0, 0x03, 0x02, 0x01, 0x02, 0x02, 0x08, 0x71,
    0x13, 0x4d, 0xcf, 0xde, 0x8a, 0x54, 0xc8, 0x30, 0x0a, 0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d,
    ...
    ,
    ...
    ,
};

ByteSpan kDacCert = ByteSpan(Dac_Cert_Array);

// Dac PUBLIC KEY FROM credentials/test/attestation/test-DAC-1141-8005-key.pem 

constexpr uint8_t Dac_PublicKey_Array[] = {
    0x04, 0xe0, 0x25, 0x06, 0x62, 0x4c, 0xe8, 0x2b, 0x87, 0x86, 0x8e, 0x73, 0x2f, 0x1e, 0xcc, 
    0xb7, 0x20, 0xf9, 0x15, 0x55, 0x21, 0xfe, 0x28, 0xeb, 0x77, 0xa0, 0x3d, 0xdb, 0xca, 0xe0, 
    0xe7, 0x80, 0x22, 0x65, 0xdd, 0xf7, 0xd0, 0x6e, 0x44, 0xfc, 0x8e, 0x70, 0x93, 0x5f, 0x73, 
    0x30, 0x28, 0xd7, 0x41, 0x15, 0xcc, 0x12, 0xb5, 0x23, 0x55, 0x75, 0x24, 0xde, 0xa5, 0x52, 
    0xf6, 0x89, 0xe3, 0x77, 0x64
};

ByteSpan kDacPublicKey = ByteSpan(Dac_PublicKey_Array);

// Dac PRIVATE KEY FROM credentials/test/attestation/test-DAC-1141-8005-key.pem 

constexpr uint8_t Dac_PrivateKey_Array[] = {
    0x51, 0xa4, 0x94, 0xfb, 0x84, 0xce, 0xcf, 0x1f, 0x63, 0x3e, 0x46, 0xee, 0xa2, 0xe2, 0xa6, 
    0x40, 0x93, 0x09, 0x73, 0x0d, 0x62, 0x50, 0x10, 0xbb, 0x71, 0x48, 0x29, 0x86, 0x0e, 0xdf, 
    0xc9, 0x28
};
