...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDeltadelfinAnimationGradientClusterSetAnimationParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDeltadelfinAnimationGradientClusterSetGradientParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRDeltadelfinAnimationGradientClusterSetDisplayModeParams : NSObject <NSCopying>
