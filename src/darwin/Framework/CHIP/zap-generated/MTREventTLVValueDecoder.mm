...
static id _Nullable DecodeEventPayloadForDeltadelfinAnimationGradientCluster(EventId aEventId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    using namespace Clusters::DeltadelfinAnimationGradient;
    switch (aEventId) {
    default: {
        // Not a known DeltadelfinAnimationGradient event.
        break;
    }
    }
...
id _Nullable MTRDecodeEventPayload(const ConcreteEventPath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    case Clusters::DeltadelfinAnimationGradient::Id: {
        return DecodeEventPayloadForDeltadelfinAnimationGradientCluster(aPath.mEventId, aReader, aError);
    }
